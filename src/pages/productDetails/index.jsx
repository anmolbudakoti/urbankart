        ...
        <div>
           <div className='m-3'>
            ...
            <div className='p-3 flex justify-center items-center'>
                <div className='grid items-center grid-cols-5 shadow-md rounded-lg p-3 gap-12'>
                    <div className='w-full col-span-3 sticky top-0 text-center'>
                    ...
                    <div className='col-span-2 justify-items-center'>
                        ...
                        <div className='m-3 flex flex-col gap-3'>
                            <button disabled={cartItems.findIndex((item)=> item.id === productDetails.id) > -1} onClick={()=> addToCart(productDetails)} className='disabled:opacity-65 px-2 py-2 md:px-6 md:py-3 lg:px-14 border border-black text-xs md:text-sm font-semibold rounded'>{cartItems.findIndex((item)=> item.id === productDetails.id) > -1 ? "Added in the Cart" : "Add to Cart"}</button>
                            <button onClick={()=> navigate("/cart")} className='px-2 py-2 md:px-6 md:py-3 lg:px-14 bg border bg-green-800 hover:bg-green-600 active:bg-green-500 text-white text-xs md:text-sm font-semibold rounded-md'>Go to Cart</button>
                        </div>
                    </div>
                </div>
            </div>
